...
%% U V compare
fig_uvcomp = figure;
fig_uvcomp.PaperUnits = 'centimeters';
fig_uvcomp.PaperSize = [29.7 21]; % A4 papersize (horizontal,21-by-29.7 cm,[width height])
fig_uvcomp.PaperType = '<custom>';
fig_uvcomp.WindowState = 'maximized';
fig_uvcomp
ax1 = axes;
